...
class CavesControllerTest < ActionController::TestCase
  ...
  test "should create cafe" do
    assert_difference('Cafe.count') do
      post :create, cafe: { address: @cafe.address, name: @cafe.name, phone: @cafe.phone, website: @cafe.website }
    end
  ...
  test "should update cafe" do
    patch :update, id: @cafe, cafe: { address: @cafe.address, name: @cafe.name, phone: @cafe.phone, website: @cafe.website }
    assert_redirected_to cafe_path(assigns(:cafe))
  end
