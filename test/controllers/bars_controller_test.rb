...
class BarsControllerTest < ActionController::TestCase
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post :create, bar: { address: @bar.address, name: @bar.name, phone: @bar.phone, website: @bar.website }
    end
  ...
  test "should update bar" do
    patch :update, id: @bar, bar: { address: @bar.address, name: @bar.name, phone: @bar.phone, website: @bar.website }
    assert_redirected_to bar_path(assigns(:bar))
  end
